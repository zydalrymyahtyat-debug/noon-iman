  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-6 space-y-12">
      <div className="text-center space-y-4">
        <h2 className="text-3xl font-bold font-serif text-teal-700 dark:text-teal-400">
          المسبحة الإلكترونية
        </h2>
      ...
      >
        ...
        <span className="text-7xl font-bold font-sans tracking-tighter relative z-10">
          {count}
        </span>
        <span className="text-sm font-medium mt-4 opacity-80 relative z-10">
          اضغط للتسبيح
        </span>
      </motion.button>
