...
export const StoriesView: React.FC = () => {
  ...
  const stories = [
    { 
      ...
      content: 'خلق الله تعالى آدم عليه السلام بيديه من طين، ونفخ فيه من روحه، وأمر الملائكة بالسجود له تكريماً. سجد الملائكة جميعاً إلا إبليس أبى واستكبر. أسكن الله آدم وزوجته حواء الجنة، ونهاهما عن الأكل من شجرة معينة. فوسوس لهما الشيطان فأكلا منها، فأهبطهما الله إلى الأرض لتبدأ مسيرة البشرية وخلافتهم فيها.'
    },
    { 
      id: 2, 
      title: 'قصة نوح عليه السلام', 
      summary: 'شيخ المرسلين وقصة الطوفان العظيم.',
      content: 'أرسل الله نوحاً عليه السلام إلى قومه ليدعوهم إلى التوحيد وترك عبادة الأصنام. استمر في دعوتهم ألف سنة إلا خمسين عاماً، ولم يؤمن معه إلا قليل. فأمره الله بصنع سفينة، وأوحى إليه أن يحمل فيها من كل زوجين اثنين. ثم جاء الطوفان العظيم الذي أغرق الكافرين ومنهم ابنه، ونجى الله نوحاً ومن معه.'
    },
    { 
      id: 3, 
      title: 'قصة إبراهيم عليه السلام', 
      summary: 'خليل الرحمن وبناء الكعبة.',
      content: 'وُلد إبراهيم عليه السلام في بابل، ودعا قومه وأباه لترك عبادة الأصنام، فحطم أصنامهم، فألقوه في نار عظيمة جعلها الله برداً وسلاماً عليه. هاجر إلى الشام ثم إلى مكة، وأمره الله ببناء الكعبة المشرفة مع ابنه إسماعيل عليه السلام، وامتحنه الله بذبح ابنه ففداه بذبح عظيم.'
    },
    { 
      id: 4, 
      title: 'قصة موسى عليه السلام', 
      summary: 'كليم الله وخروجه مع بني إسرائيل.',
      content: 'وُلد موسى عليه السلام في عام يقتل فيه فرعون المواليد الذكور، فألقت أمه به في اليم، ليربى في قصر فرعون. كبر موسى وخرج إلى مدين، ثم عاد نبياً مرسلاً لفرعون وقومه. أيده الله بالمعجزات كالعصا واليد، وانتهت قصته مع فرعون بانشقاق البحر ونجاة بني إسرائيل وغرق فرعون وجنوده.'
    },
    { 
      id: 5, 
      title: 'قصة عيسى عليه السلام', 
      summary: 'كلمة الله وروحه، ومعجزاته.',
      content: 'عيسى عليه السلام هو نبي الله الذي ولد من السيدة مريم العذراء بكلمة من الله وبدون أب. أيده الله بمعجزات عظيمة كإبراء الأكمه والأبرص وإحياء الموتى بإذن الله. دعا بني إسرائيل لعبادة الله وحده، وتآمروا على قتله، لكن الله نجاه ورفعه إليه، وسينزل في آخر الزمان ليحكم بالعدل.'
    },
    { 
      id: 6, 
      title: 'سيرة النبي محمد ﷺ', 
      summary: 'خاتم الأنبياء والمرسلين.',
      content: 'ولد النبي محمد ﷺ في مكة يتيماً، وعُرف بالصادق الأمين. نزل عليه الوحي وهو في سن الأربعين في غار حراء. دعا إلى الإسلام في مكة وعانى من أذى قريش، فهاجر إلى المدينة المنورة حيث أسس دولة الإسلام. جاهد في سبيل الله حتى فتح مكة، وتوفي في المدينة المنورة بعد أن أكمل الله به الدين.'
    },
  ];
