      ...
      <div className="space-y-4">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden p-6 flex flex-col items-center text-center">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed space-y-3 text-right">
            <p>
              نور وإيمان هو تطبيق إسلامي يهدف إلى نشر العلم الشرعي وتيسير الوصول
              إلى المحتوى الإسلامي الموثوق، من خلال واجهة عربية بسيطة وسهلة
              الاستخدام تناسب جميع الفئات.
            </p>
            <p>يضم التطبيق مجموعة من الأقسام الإسلامية المفيدة، منها:</p>
            ...
            <p>
              نسعى إلى تطوير تطبيق نور وإيمان باستمرار وإضافة المزيد من الكتب
              والمزايا التي تعين المسلم على طلب العلم، وتعزز الوعي الديني بأسلوب
              سهل ومنظم.
            </p>
            ...
            <p className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 text-[10px] text-center opacity-80">
              شكرًا لاستخدامكم تطبيق نور وإيمان. نرحب بجميع الملاحظات
              والاقتراحات التي تسهم في تطوير التطبيق، ونسأل الله أن يجعل هذا
              العمل خالصًا لوجهه الكريم، وأن ينفع به المسلمين، وأن يجعله في
              ميزان الحسنات.
            </p>
          </div>
        </div>
