    ...
    <div className="p-4 space-y-6 h-full overflow-y-auto">
      ...
      >
        ...
        <div className="relative z-10 p-8 text-white">
          ...
          <p className="text-teal-50 font-medium text-lg opacity-90 max-w-sm">
            مرحباً بك في تطبيق نور الإيمان. اختر القسم الذي تريده من القائمة.
          </p>
        </div>
      </motion.div>
        ...
        {cards.map((card, idx) => (
          ...
          >
            ...
            <div className="relative z-10 p-4 flex flex-col h-full justify-end">
              <div
                className={`w-10 h-10 rounded-xl ${card.color} text-white flex items-center justify-center shadow-sm mb-2 opacity-90`}
              >
                {card.icon}
              </div>
