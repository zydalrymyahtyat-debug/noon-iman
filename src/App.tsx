...
const App: React.FC = () => {
  ...
  return (
    <div
      className="flex flex-col h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-50 overflow-hidden"
      dir="rtl"
    >
      <WeeklyDialog />
      ...
      <header className="h-16 shrink-0 flex items-center justify-between px-4 bg-white dark:bg-slate-900 shadow-sm z-10 relative">
        <h1 className="text-xl font-bold text-teal-600 dark:text-teal-400 font-serif">
          نور الإيمان
        </h1>
        <button
      ...
      <main className="flex-1 overflow-hidden relative">
        {currentView === "home" && (
          <HomeView onNavigate={(view) => navigateTo(view as View)} />
        )}
